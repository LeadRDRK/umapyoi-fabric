...
public class FactorDecomposeMenu extends AbstractContainerMenu {
    ...
    public void createResult() {
        if (isTaking()) return;
        var evt = new FactorDecomposeCallback.Context(this.inputSlots.getItem(0), this.factorSeed.get());
        if (!this.canProceedToResult() || FactorDecomposeCallback.invoke(evt) || evt.getListOfReturn() == null) {
