...
public class UmapyoiSkillLootTableProvider extends SimpleFabricLootTableSubProvider {
    ...
    public UmapyoiSkillLootTableProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
        consumer.accept(SIMPLE_SKILLS, LootTable.lootTable().withPool(LootPool.lootPool()
                        ...
                        .when(LootItemRandomChanceCondition.randomChance(0.15f).build())
        ...
        consumer.accept(COMPLEX_SKILLS, LootTable.lootTable().withPool(LootPool.lootPool()
                        ...
                        .when(LootItemRandomChanceCondition.randomChance(0.5f).build())
