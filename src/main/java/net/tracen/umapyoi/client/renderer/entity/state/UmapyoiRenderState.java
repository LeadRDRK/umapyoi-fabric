...
public interface UmapyoiRenderState {
    ...
    default Identifier umapyoi$getUmaTexture() {
        return null;
    }

    default void umapyoi$setUmaTexture(Identifier umaTexture) {
    }

    default Identifier umapyoi$getSuitTexture() {
        return null;
    }

    default void umapyoi$setSuitTexture(Identifier suitTexture) {
    }

    default Identifier umapyoi$getUmaEmissiveTexture() {
        return null;
    }

    default void umapyoi$setUmaEmissiveTexture(Identifier umaEmissiveTexture) {
    }
}
