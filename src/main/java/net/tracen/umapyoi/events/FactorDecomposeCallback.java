 ...
 */
public interface FactorDecomposeCallback {
    class Context {
        ...
        public Context(ItemStack inputStack, int random) {
    ...
    Event<FactorDecomposeCallback> EVENT = EventFactory.createArrayBacked(FactorDecomposeCallback.class,
            (listeners) -> (context) -> {
                for (FactorDecomposeCallback listener : listeners) {
