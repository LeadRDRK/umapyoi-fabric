...
public class UmapyoiItemTagsProvider extends ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        getOrCreateTagBuilder(UmapyoiItemTags.SR_UMA_TICKET).add(ItemRegistry.SR_UMA_TICKET);
        getOrCreateTagBuilder(UmapyoiItemTags.SSR_UMA_TICKET).add(ItemRegistry.SSR_UMA_TICKET);
        getOrCreateTagBuilder(UmapyoiItemTags.SR_CARD_TICKET).add(ItemRegistry.SR_CARD_TICKET);
        getOrCreateTagBuilder(UmapyoiItemTags.SSR_CARD_TICKET).add(ItemRegistry.SSR_CARD_TICKET);
        ...
        getOrCreateTagBuilder(UmapyoiItemTags.HORSESHOE).add(ItemRegistry.HORSESHOE_GOLD)
            .add(ItemRegistry.HORSESHOE_SILVER).add(ItemRegistry.HORSESHOE_RAINBOW);
        getOrCreateTagBuilder(UmapyoiItemTags.HORSESHOE_RAINBOW).add(ItemRegistry.HORSESHOE_RAINBOW);
    }
