...
public class VillageRegistry {
    public static final ResourceLocation TRAINER_POI = Umapyoi.id("trainer_poi");
    ...
    private static void register(ResourceKey<VillagerProfession> key, ResourceLocation poi, SoundEvent sound) {
        Registry.register(
