    ...
    public static void registerAll(BootstrapContext<SupportCard> bootstrap) {
        ...
        bootstrap.register(SSR_ANIME_MAIN,
                SupportCard.Builder.create()
                        ...
                        .addSupporter(UmaDataRegistry.SPECIAL_WEEK.identifier())
                        .addSupporter(UmaDataRegistry.TOKAI_TEIO.identifier())
                        .addSupporter(UmaDataRegistry.KITASAN_BLACK.identifier())
        ...
        bootstrap.register(SSR_KIRYUUIN_AOI,
                SupportCard.Builder.create()
                        ...
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "kiryuuin_aoi"))
        ...
        bootstrap.register(SSR_SATONO_DIAMOND_STAMINA,
                SupportCard.Builder.create()
                        ...
                        .addSupporter(UmaDataRegistry.SATONO_DIAMOND.identifier())
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STAMINA_SUPPORT.getId(), 3))
        ...
        bootstrap.register(SSR_NEO_UNIVERSE_WIDSOM,
                SupportCard.Builder.create()
                        ...
                        .addSupporter(UmaDataRegistry.NEO_UNIVERSE.identifier())
        ...
        bootstrap.register(SSR_THREE_GODDESSES,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(2)
                        .supportType(SupportType.GROUP)
                        .addSupporter(UmaDataRegistry.DARLEY_ARABIAN.identifier())
                        .addSupporter(UmaDataRegistry.GODOLPHIN_BARB.identifier())
                        .addSupporter(UmaDataRegistry.BYERLEY_TURK.identifier())
                        .addSupport(new SupportEntry(TrainingSupportRegistry.SPEED_SUPPORT.getId(), 2))
        ...
        bootstrap.register(SSR_TEAM_SIRIUS,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(1)
                        .supportType(SupportType.GROUP)
                        .addSupporter(UmaDataRegistry.MEJIRO_MCQUEEN.identifier())
                        .addSupporter(UmaDataRegistry.RICE_SHOWER.identifier())
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "winning_ticket"))
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "narita_brian"))
                        .addSupporter(UmaDataRegistry.SILENCE_SUZUKA.identifier())
                        .addSupporter(UmaDataRegistry.SPECIAL_WEEK.identifier())
                        .addSupport(new SupportEntry(TrainingSupportRegistry.SPEED_SUPPORT.getId(), 3))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STAMINA_SUPPORT.getId(), 3))
        ...
        bootstrap.register(SSR_ORFEVRE,
                SupportCard.Builder.create()
                        ...
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "orfevre"))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.SPEED_SUPPORT.getId(), 2))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STRENGTH_SUPPORT.getId(), 1))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.GUTS_SUPPORT.getId(), 3))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.AP_SUPPORT.getId(), 1))
        ...
        bootstrap.register(SSR_ACUPUNCTUIST,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(3)
                        .supportType(SupportType.FRIENDSHIP)
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "anshinzawa_sasami"))
        ...
        bootstrap.register(R_TM_OPERA,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(10)
                        .supportType(SupportType.STAMINA)
                        .addSupporter(UmaDataRegistry.TM_OPERA_O.identifier())
        ...
        bootstrap.register(R_SUPERCREEK,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(10)
                        .supportType(SupportType.STAMINA)
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "super_creek"))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STAMINA_SUPPORT.getId(), 1))
        ...
        bootstrap.register(R_OGURICAP,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(10)
                        .supportType(SupportType.STRENGTH)
                        .addSupporter(UmaDataRegistry.OGURI_CAP.identifier())
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STAMINA_SUPPORT.getId(), 1))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STRENGTH_SUPPORT.getId(), 1))
                        .build());
        ...
        bootstrap.register(R_AGNUS_TACHYON,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(10)
                        .supportType(SupportType.WISDOM)
                        .addSupporter(UmaDataRegistry.AGNUS_TACHYON.identifier())
        ...
        bootstrap.register(R_KS_MIRACLE,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(10)
                        .supportType(SupportType.GUTS)
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "ks_miracle"))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.GUTS_SUPPORT.getId(), 2))
                        .build());
        ...
        bootstrap.register(SSR_FINE_MOTION,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(5)
                        .supportType(SupportType.WISDOM)
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "fine_motion"))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.WISDOM_SUPPORT.getId(), 3))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.SPEED_SUPPORT.getId(), 1))
        ...
        bootstrap.register(SSR_RUDOLF_G,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(6)
                        .supportType(SupportType.GUTS)
                        .addSupporter(UmaDataRegistry.SYMBOLI_RUDOLF.identifier())
                        .addSupport(new SupportEntry(TrainingSupportRegistry.GUTS_SUPPORT.getId(), 3))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.SPEED_SUPPORT.getId(), 2))
                        .addSupport(new SupportEntry(TrainingSupportRegistry.STRENGTH_SUPPORT.getId(), 1))
                        .build());
        ...
        bootstrap.register(SSR_MEJIRO_RAMONU_W,
                SupportCard.Builder.create()
                        ...
                        .maxDamage(5)
                        .supportType(SupportType.WISDOM)
                        .addSupporter(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "mejiro_ramonu"))
