...
public class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> GATE_OPEN = SOUNDS.register("gate_open",
            () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "gate_open")));

    public static final RegistryObject<SoundEvent> GATE_CLOSE = SOUNDS.register("gate_close",
            () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(Umapyoi.MODID, "gate_close")));
}
