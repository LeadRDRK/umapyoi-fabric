...
public class LowHealthBuffSkill extends UmaSkill {
    ...
    public void applySkill(ServerLevel level, LivingEntity user) {
        ...
        user.addEffect(new MobEffectInstance(MobEffects.SPEED, 100 * this.getSkillLevel(),
                lowHealth ? this.getSkillLevel() : this.getSkillLevel() - 1));
        user.addEffect(new MobEffectInstance(MobEffects.STRENGTH, 100 * this.getSkillLevel(),
                lowHealth ? this.getSkillLevel() : this.getSkillLevel() - 1));
    }
